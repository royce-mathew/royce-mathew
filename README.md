<p align="center">
	...
	<ul>
		...
		<li>
			...
			<ul>
				<li>REST APIs</li>
				<li>Automation using Selenium</li>
				<li>Windows API</li>
			</ul>
		</li>
		<li>
			<p>
				<strong>Ro-Info</strong>: Get user data through requests and efficiently store it locally
			</p>
			<ul>
				<li>Multithreaded Proxy Handler</li>
				<li>Prevents Hitting Rate Limits from Servers</li>
			</ul>
		</li>
	</ul>
	<h3 id="java">Java</h3>
